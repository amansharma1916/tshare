...
export const endpoints = {
    ...
    adminDeletionRequests: `${API_URL}/admin/deletion-requests`,
    adminProcessDeletionRequest: (id) => `${API_URL}/admin/deletion-requests/${id}/process`,
    adminRejectDeletionRequest: (id) => `${API_URL}/admin/deletion-requests/${id}/reject`,
    accountDeleteRequest: `${API_URL}/account-delete-request`,
